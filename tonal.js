...
var Tonal = (() => {
    ...
    var pt = (t, n) => {
        ...
        Wn = (t, n, e, r) => {
            if ((n && typeof n == 'object') || typeof n == 'function')
                for (let o of Qn(n)) !Jn.call(t, o) && o !== e && ft(t, o, { get: () => n[o], enumerable: !(r = Xn(n, o)) || r.enumerable })
            return t
        }
    ...
    function re(t) {
        ...
        return { empty: !1, acc: r, alt: i, chroma: j, coord: c, freq: C, height: f, letter: e, midi: x, name: P, oct: m, pc: h, step: a }
    }
    function oe(t) {
    ...
    function se(t) {
        ...
        return { empty: !1, name: m, num: e, q: r, step: o, alt: h, dir: c, type: i, simple: P, semitones: f, chroma: x, coord: C, oct: j }
    }
    function G(t, n) {
        let [e, r = 0] = t,
            o = e * 7 + r * 12 < 0,
    ...
    function ce(t, n) {
        return (n === 'M' && t === 'majorable') || (n === 'P' && t === 'perfectable')
            ? 0
            : n === 'm' && t === 'majorable'
            ? -1
            : /^A+$/.test(n)
    ...
    var nn = { abcToScientificNotation: nt, scientificToAbcNotation: tn, tokenize: Zt, transpose: fe, distance: pe }
    var bt = {}
    pt(bt, {
        compact: () => ye,
        permutations: () => rn,
    ...
    function rr(t, n, e) {
        ...
        return (
            i.forEach((c, P) => {
                ...
                S()
                    .filter((f) => (e.assumePerfectFifth && nr(f) ? f.chroma === h : f.chroma === c))
                    .forEach((f) => {
                        let x = f.aliases[0],
                            C = a(P)
    ...
    function Q(t) {
        let [n, e, r, o] = H(t)
        return n === '' ? ['', t] : n === 'A' && o === 'ug' ? ['', 'aug'] : [n + e, r + o]
    }
    function O(t) {
        if (t === '') return xt
    ...
    var dn = { getChord: mt, get: O, detect: St, chordScales: pr, extended: Pr, reduced: Mr, tokenize: Q, transpose: fr, degrees: hr, steps: vr, chord: dr }
    var yr = [
    ...
    var Ar = { empty: !0, name: '', value: 0, fraction: [0, 0], shorthand: '', dots: '', names: [] }
    function gr() {
    ...
    var xn = { empty: !0, name: '', chordType: '' },
        jn = {}
    function y(t) {
        return typeof t == 'string' ? jn[t] || (jn[t] = go(t)) : typeof t == 'number' ? y(ut[t] || '') : q(t) ? vo(t) : k(t) ? y(t.name) : xn
    }
    ...
    var yo = /^(#{1,}|b{1,}|x{1,}|)(IV|I{1,3}|VI{0,2}|iv|i{1,3}|vi{0,2})([^IViv]*)$/
    function bo(t) {
        return yo.exec(t) || ['', '', '', '']
    }
    ...
    var M = Object.freeze([]),
        ...
        No = { ...Dn, type: 'minor', relativeMajor: '', natural: lt, harmonic: lt, melodic: lt },
    ...
    function Eo(t) {
        ...
        if (!n) return No
        let e = _n('C', n) - 3
        return { type: 'minor', tonic: n, relativeMajor: u(n, '3m'), alteration: e, keySignature: E(e), natural: To(n), harmonic: jo(n), melodic: xo(n) }
    }
    function Do(t) {
        return typeof t == 'number' ? W('C', t) : typeof t == 'string' && /^b+|#+$/.test(t) ? W('C', _(t)) : null
    }
    ...
    var $n = { get: R, names: Fo, all: Vn, distance: Rn, relativeTonic: ko, notes: Oo, triads: Ro, seventhChords: $o, entries: wo, mode: _o }
    function qo(t, n) {
    ...
    var Bo = { empty: !0, name: '', type: '', tonic: null, setNum: NaN, chroma: '', normalized: '', aliases: [], notes: [], intervals: [] }
    function Ln(t) {
    ...
    var ta = { empty: !0, name: '', upper: void 0, lower: void 0, type: void 0, additive: [] },
    ...
    function ia([t, n]) {
        ...
        let o = Array.isArray(t) ? `${t.join('+')}/${n}` : `${t}/${n}`,
            a = Array.isArray(t) ? t : [],
            i = r === 4 || r === 2 ? 'simple' : r === 8 && e % 3 === 0 ? 'compound' : aa(r) ? 'irregular' : 'irrational'
